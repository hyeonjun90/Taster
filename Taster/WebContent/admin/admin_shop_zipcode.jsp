...
<script>
	function AdminshopZipcode(){
		$("#zipcode").html("<center><h3>LOADING...</h3></center>")
		$.ajax({
			url:"AdminShopSearchZipcodeSearch.action",
			method:"post",
	...
	<table width="370" border="0" cellsapcing="0" cellpadding="5">
		<tr align="center">
			<td align="center">
				...
				<input type="text" name="dong" id="dong" onkeydown="javascript:if(event.keyCode==13){ AdminshopZipcode(); return false; }"/>
				<input type="button" value="검색" onclick="AdminshopZipcode();"><br>
