...
<body>
	...
	<s:if test="resultClass == NULL">
		<form action="rboardWriteAction.action" method="post" enctype="multipart/form-data" onsubmit="return validation();">
	</s:if>
	...
	<table width="600" border="0" cellspacing="0" cellpading="0">
		...
		<tr>
			...
			<td width="500" bgcolor="#FFFFFF">
				<s:textfield name="subject" theme="simple" value="%{resultClass.rec_subject}" cssStyle="width:370px" maxlength="50"/>
			</td>
		</tr>
		...
		<%-- <tr>
			...
			<td bgcolor="#FFFFFF">
				<s:textfield name="password" theme="simlpe" value="%{resultClass.password}" cssStype="width:100px" maxlength="20"/>
			</td>
		</tr>
		...
		<tr>
			...
			<td bgcolor="#FFFFFF">
				<s:textarea name="content" theme="simple"  value="%{resultClass.rec_content}" cols="50" rows="10"/>
			</td> 
		</tr>
