...
public class AdminShopListpagingAction {
	...
	public AdminShopListpagingAction(int currentPage, int totalCount, int blockCount, int blockPage, int searchNum, String isSearch)
	{
